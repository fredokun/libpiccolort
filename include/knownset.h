...
extern bool/*void*/ PICC_knownset_add(PICC_KnownSet *s, PICC_KnownValue *val); 
// the bool return is needed in the compilation shema !!!!
// return true if val wasn't already in the set
